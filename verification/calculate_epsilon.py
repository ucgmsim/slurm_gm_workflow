...
for im in im_names:
    if im == 'component':
        ...
        emp_im = 'emp_' + im
        merged_data[im_epsilon] = (np.log(merged_data[im].values) - np.log(merged_data[emp_im])) / merged_data[emp_sigma]

merged_data.sort_index(inplace=True)
merged_data.to_csv(args.out, columns=['component', 'PGA_epsilon', 'PGV_epsilon', 'CAV_epsilon', 'AI_epsilon',  'Ds575_epsilon', 'Ds595_epsilon', 'pSA_0.02_epsilon', 'pSA_0.05_epsilon', 'pSA_0.1_epsilon', 'pSA_0.2_epsilon', 'pSA_0.3_epsilon', 'pSA_0.4_epsilon', 'pSA_0.5_epsilon', 'pSA_0.75_epsilon', 'pSA_1.0_epsilon', 'pSA_2.0_epsilon', 'pSA_3.0_epsilon', 'pSA_4.0_epsilon', 'pSA_5.0_epsilon', 'pSA_7.5_epsilon', 'pSA_10.0_epsilon'])
