...
cd $sim_dir
fd_ll=`python -c "from workflow import sim_params; p = sim_params.load_sim_params('sim_params.yaml'); print(p['FD_STATLIST'])"`
...
python $gmsim/workflow/workflow/calculation/verification/test_binary.py $bb_bin $fd_ll bb --verbose
