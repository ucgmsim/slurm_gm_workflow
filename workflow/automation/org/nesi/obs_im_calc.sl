...
do
    ...
    then
        ...
        python $gmsim/workflow/workflow/calculation/verification/im_calc_checkpoint.py ${obs_dirs}/IM_calc/ $((`ls $D/*/*/accBB | wc -l` / 3)) $comp_count --event_name ${fault_name} --observed
        if [[ $? == 1 ]]; then
