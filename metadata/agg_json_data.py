...
def create_dataframe(json_file):
    """Create a dataframe for the given nested dictionary

    for the format of write_json.py output files
    """
...
if __name__ == '__main__':
    ...
    parser.add_argument("-nr", "--not_recursive", action="store_true",
                        help="Disables recursive file searching",
                        default=False)
    parser.add_argument("-fp", "--filename_pattern", type=str,
                        default="all_sims",
