...
def action(version, sim_dir, event_name, run_name, run_dir, vel_mod_dir,
           ...
           v1d_dir=defaults.vel_mod_dir, user_root=defaults.user_root,
           stat_dir=defaults.stat_dir, site_v1d_dir=None, hf_stat_vs_ref=None,
           v1d_full_path=None, sim_params_file='', dt=default_dt):
