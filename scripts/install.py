...
def install_bb(v1d, stat_file, root_dict, site_v1d_dir=None, hf_stat_vs_ref=None):
    ...
    # TODO:add in logic for site specific as well, if the user provided as args
        ...
        if is_site_specific_id:
            ...
            v_mod_1d_name, v_mod_1d_selected = shared.get_site_specific_path(v1d, site_v1d_dir, hf_stat_vs_ref)
            root_dict['bb']['site_specific'] = False
            root_dict['v_mod_1d_name'] = v_mod_1d_selected
...
def action(version, sim_dir, event_name, run_name, run_dir, vel_mod_dir,
           ...
           yes_statcords, yes_model_params, fault_yaml_path, root_yaml_path, v1d_dir, site_v1d_dir, hf_stat_vs_ref, user_root, stat_dir=defaults.stat_dir):
...
def main_local(args):
    ...
    v_mod_ver, vel_mod_dir_full, params_vel_path = q_select_vel_model(args.vel_mod_dir)
    ...
    root_params_dict, fault_params_dict, sim_params_dict, vm_params_dict = action(
        ...
        yes_model_params, fault_yaml_path, root_yaml_path, args.v1d_dir, args.site_v1d_dir, args.hf_stat_vs_ref, args.user_root, args.station_dir)
...
def main_remote(cfg, args):
    ...
    root_params_dict, fault_params_dict, sim_params_dict, vm_params_dict = action(
        ...
        fault_yaml_path, root_yaml_path, args.v1d_dir, args.site_v1d_dir, args.hf_stat_vs_ref, args.user_root, args.station_dir)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--vm_dir', type=str, default=defaults.vel_mod_dir,
                        help="path that contains VMs, params_vel must "
                             "be present")
    parser.add_argument('--v1d_dir', type=str, default=defaults.v_mod_1d_dir)
