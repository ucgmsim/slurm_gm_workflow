...
from scripts import parallel_executor
...
if rank == 0:
    ...
    verify_user_dirs([hf_accdir],
                     reset=not hf_resume)  # to resume from the checkpoint, reset=False. The combo of hf_resume=True and rand_reset=False is not recommended for reproducibility
