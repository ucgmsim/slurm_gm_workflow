...
# working files
tmp_filelist = os.path.join(bb_sim_dir,'temp.filter_list')
lf_copy = os.path.join(bb_sim_dir,'temp.lf')
hf_copy = os.path.join(bb_sim_dir,'temp.hf')
match_log_full = os.path.join(bb_sim_dir,match_log)
