...
def write_sl_script_merge_ts(lf_sim_dir, sim_dir, tools_dir, mgmt_db_location, rup_mod,
                             run_time=default_run_time_merge_ts, nb_cpus=default_core_merge_ts, memory=default_memory,
...
def write_sl_script_winbin_aio(lf_sim_dir, sim_dir, mgmt_db_location, rup_mod, run_time=default_run_time_winbin_aio,
                               nb_cpus=default_core_winbin_aio, memory=default_memory, account=default_account):
...
if __name__ == '__main__':
    ...
    try:
        ...
        if args.srf is None or srf_name == args.srf:
            ...
            if args.merge_ts:
                created_script = write_sl_script_merge_ts(lf_sim_dir, params.sim_dir, tools_dir,
            ...
            if args.winbin_aio:
                created_script = write_sl_script_winbin_aio(lf_sim_dir, params.sim_dir, params.mgmt_db_location,
                                                            srf_name)
                jobid = submit_sl_script(created_script, submit_yes)
                if jobid is not None:
