...
def submit_im_calc_slurm(sim_dir: str, options_dict: Dict = None, est_model: EstModel = None, logger=None):
    ...
    log(logger, INFO, "Running wall clock estimation for IM sim")
