...
from scripts.type.cybershake.add_to_mgmt_queue import add_to_queue
from scheduler.management import create_mgmt_db
from scheduler.management import connect_db_ctx
from tests.e2e.E2ETests import NonBlockingStreamReader, Error
    ...
    def _run_auto(self, sleep_time: int = 10):
        ...
        submit_cmd = "python {} {} --sleep_time 2".format(
            os.path.join(
                ...
                "../../scripts/type/cybershake/queue_monitor.py",
            ),
            self.stage_dir,
        )
