...
from scripts.common import shared_template
from tests.unit.test_common_set_up import (
    get_input_params,
    get_bench_output,
)
...
def test_write_sl_script(set_up, mocker):
    ...
    for root_path, realisation in set_up:
        ...
        #unit if the test_output is non-zero output. it doesn't check whether this .sl script makes sense (it will be covered by end-to-end test)
