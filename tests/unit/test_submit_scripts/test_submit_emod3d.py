...
from scripts.common.shared import set_wct as mocked_set_wct

from tests.unit.test_common_set_up import get_fault_from_rel

# from unit.conftest import init_scheduler

import scripts.submit.submit_emod3d
...
def test_main(set_up, mocker):
    ...
    for root_path, realisation in set_up:
        ...
        scripts.submit.submit_emod3d.main(
            submit=None,
            machine="default",
            ncores=160,
            rel_dir=rel_dir,
